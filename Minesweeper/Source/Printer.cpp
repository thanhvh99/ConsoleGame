...
//debug
void Printer::printFlagsSurround(bool _2Line)
{
    table(0, 2, minesweeper->getCol(), minesweeper->getRow(), COL_WIDTH, ROW_HEIGHT, _2Line);
    int row = minesweeper->getRow();
    int col = minesweeper->getCol();
    ...
    for (int i = 0; i < row; i++)
    {
        ...
        {
            gotoXY(2 + j * (COL_WIDTH + 1), 3 + i * (ROW_HEIGHT + 1));
            cout << minesweeper->getFlagsSurround(j, i);
        }
    }
}

void Printer::printCoveredTilesSurround(bool _2Line)
{
    table(0, 2, minesweeper->getCol(), minesweeper->getRow(), COL_WIDTH, ROW_HEIGHT, _2Line);
    int row = minesweeper->getRow();
    int col = minesweeper->getCol();
    ...
    for (int i = 0; i < row; i++)
    {
        ...
        {
            gotoXY(2 + j * (COL_WIDTH + 1), 3 + i * (ROW_HEIGHT + 1));
            cout << minesweeper->getCoveredTilesSurround(j, i);
        }
    }
}

void Printer::printCovered(bool _2Line)
{
    table(0, 2, minesweeper->getCol(), minesweeper->getRow(), COL_WIDTH, ROW_HEIGHT, _2Line);
    int row = minesweeper->getRow();
    int col = minesweeper->getCol();
    ...
    for (int i = 0; i < row; i++)
    {
        ...
        {
            gotoXY(2 + j * (COL_WIDTH + 1), 3 + i * (ROW_HEIGHT + 1));
            cout << minesweeper->isCovered(j, i);
        }
    }
}

void Printer::printFlagged(bool _2Line)
{
    table(0, 2, minesweeper->getCol(), minesweeper->getRow(), COL_WIDTH, ROW_HEIGHT, _2Line);
    int row = minesweeper->getRow();
    int col = minesweeper->getCol();
    ...
    for (int i = 0; i < row; i++)
    {
        ...
        {
            gotoXY(2 + j * (COL_WIDTH + 1), 3 + i * (ROW_HEIGHT + 1));
            cout << minesweeper->isFlagged(j, i);
        }
    }
}
